...
class MultipleChoiceViewController: UIViewController {
    ...
    func showAlert(forReason reason: Int) {
        switch reason {
        case 0:
            quizAlertView = QuizAlertView(withTitle: "You're Done", andMessage: "Time is Up", colors: [backgroundColor,foregroundColor])
        case 1:
            quizAlertView = QuizAlertView(withTitle: "WRONG", andMessage: "Incorrect Answer", colors: [backgroundColor,foregroundColor])
        case 2:
            quizAlertView = QuizAlertView(withTitle: "AWESOME, You WON!", andMessage: "You have answer all of the Questions", colors: [backgroundColor,foregroundColor])
        default:
            break
        }
